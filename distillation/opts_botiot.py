def model_opts(parser):
    ...
    parser.add_argument("--ipd_vocab", type=int, default=16001)
    ...
    parser.add_argument("--rnn_hidden_bits", type=int, default=8,
    ...
    parser.add_argument("--loss_factor", type=float, default=0.8,
                        help="ISCXVPN2016: 0.8, BOTIOT: 0.8, CICIOT2022: 3, PeerRush: 1")
    parser.add_argument("--focal_loss_gamma", type=float, default=0.5,
...
def training_opts(parser):
    ...
    # Distillation
    parser.add_argument("--a", type=float, default=0.7, help="usually 0.1-0.5.")
    parser.add_argument("--T", type=int, default=3, help="usually 5-10.")
