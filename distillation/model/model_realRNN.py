...
class StandardRNNCell(nn.Module):
    def __init__(self, rnn_in_bits, rnn_hidden_bits):
        super(StandardRNNCell, self).__init__()
        self.cell = nn.RNNCell(rnn_in_bits, rnn_hidden_bits)
...
class realRNN(nn.Module):
    def __init__(self, args):
        ...
        self.standard_rnn = StandardRNNCell(self.rnn_in_bits, self.rnn_hidden_bits)
    ...
    def forward(self, len_x, ipd_x):
        ...
        rnn_out = self.standard_rnn(rnn_in, self.window_size)
