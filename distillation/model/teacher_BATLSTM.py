...
from distillation.utils.binary_ops import BinaryOps
...
class BinaryLSTMWithAttention(nn.Module):
    def __init__(self, args):
        super(BinaryLSTMWithAttention, self).__init__()
        # Feature embedding
        ...
        self.activation_quantizer = BinaryOps.apply
        ...
        self.attention = Attention(self.rnn_hidden_bits)
    ...
    def forward(self, len_x, ipd_x):
        ...
        lstm_out, _ = self.lstm(lstm_in_bin)  # lstm_out: [batch_size, seq_len, hidden_size]
        
        final_hidden = self.attention(lstm_out)  # [batch_size, hidden_size]
