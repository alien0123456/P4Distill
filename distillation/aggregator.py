...
# from Distillation.Hinton.model.model_L1 import BinaryLSTM

from utils.model_rwi import *
from trainer2 import build_data_loader, batch2segs
...
def main():
    ...
    parser.add_argument("--loss_type", default="KL",
                        choices=["KL"])
    parser.add_argument("--teacher_name", default="BinaryLSTM",
                        choices=["BinaryLSTM",
                                "BinaryL3LSTM",
    ...
    args.model_dir = './save/{}/{}/{}/studentbrnn_len{}_ipd{}_ev{}_hidden{}_{}_T{}_a{}/'.format(
        args.dataset, 
        args.teacher_name,
        args.loss_type,
    ...
    model_path = args.model_dir + 'student-best'
